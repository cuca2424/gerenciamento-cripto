...
function Carteiras({carteiras = [], funcaoRecarregar}) {
    ...
    return(
        <div class="card h-100 ">
          <div className="carteiras">
            <div class="mb-0 border-0 d-flex justify-content-between align-items-start">
                <div className="m-2">
                  <h3 class="text-body-highlight m-1">Carteiras</h3>
                </div>

                <div class="d-flex gap-3 m-2 ms-auto">
